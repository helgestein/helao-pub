...
config['echem']['procedures']['cp'] = {'procedure': 'cp',
           'setpointjson': {'applycurrent': {'Setpoint value': 10**-4},
                         'recordsignal': {'Duration': 10}},
           'plot': 'tCV',
           'onoffafter': 'off',
           'safepath': r"C:\Users\SDC_1\Documents\deploy\helao-dev\temp",
...
config['echem']['procedures']['eis'] = {'procedure': 'eis',
            'setpointjson': {'FHSetSetpointPotential': {'Setpoint value': 0.01}},
            'plot': 'impedance',
            'onoffafter': 'off',
            'safepath': r"C:\Users\SDC_1\Documents\deploy\helao-dev\temp",
            'filename': 'eis.nox',
...
config['lang'] = dict(vx = 5, vy = 5, vz = 5, port = 'COM4', 
                      ...
                      sample_offset = [9.5, 13.0, 2.0],  
                      safe_home_pos = [0.0, 0.0, 2.0], #-55, -18, -7
                      safe_waste_pos = [50.0, 135.0, 2.0], # 60.0, 70.0, -6.1348, #2.0, 85.0, 0.0
                      safe_sample_pos = [12.0, 16.0, 2.0], #60.0, 5.0, 2.0
                      remove_drop= [95.0, 135.0, 5])
