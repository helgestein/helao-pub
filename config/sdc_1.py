...
config['servers'] = dict(pump=dict(host="127.0.0.1", port=13370),
                         pumpDriver=dict(host="127.0.0.1", port=13371),
                         mecademicServer=dict(host="127.0.0.1", port=13372),
                         movementServer=dict(host="127.0.0.1", port=13373),
                         autolab=dict(host="127.0.0.1", port=13394),
                         autolabDriver=dict(host="127.0.0.1", port=13375),
                         kadi=dict(host="127.0.0.1", port=13376),
                         kadiDriver=dict(host="127.0.0.1", port=13377),
                         force=dict(host="127.0.0.1", port=13378),
                         forceDriver=dict(host="127.0.0.1", port=13379),
                         orchestrator=dict(host="127.0.0.1", port=13380),
                         lang=dict(host="127.0.0.1", port=13381),
                         langDriver=dict(host="127.0.0.1", port=13382),
                         minipump=dict(host="127.0.0.1", port=13389),
                         minipumpDriver=dict(host="127.0.0.1", port=13344),
                         measureDriver=dict(host="127.0.0.1", port=13368),
                         analysisDriver=dict(host="127.0.0.1", port=13369),
                         learningDriver=dict(host="127.0.0.1", port=13363))
