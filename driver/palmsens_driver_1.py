...
class PalmsensDevice():
    ...
    def potentiostatic_impedance_spectroscopy(self, **kwargs): 
        ...
        if isinstance(scan_type, int):
            scan_type = enumScanType(scan_type)
        ...
        stability_criterion = kwargs.get('stability_criterion', 0.001) # OCPStabilityCriterion
    ...
    def galvanostatic_impedance_spectroscopy(self, **kwargs):
        ...
        scan_type = kwargs.get('scan_type', 2)  # (0 = potential, 1 = time, 2 = fixed) # ScanType
        if isinstance(scan_type, int):
            scan_type = enumScanType(scan_type)
