    ...
    if j < 16:
        run_sequence= dict(soe=['motor/moveWaste_0', 'minipumping/formulation_0', 'motor/RemoveDroplet_0','motor/moveSample_0', 
                            ...
                            params= dict(moveWaste_0= dict(x=0, y=0, z=0),  
                                            ...
                                            measure_0= dict(procedure="cv", setpointjson= json.dumps({'FHSetSetpointPotential': {'Setpoint value': 0.4}, 
                                                        'FHWait': {'Time': 2},
                                                        'CVLinearScanAdc164':{'StartValue':0.4, 'UpperVertex':1.5, 'LowerVertex':0.399, 'NumberOfStopCrossings':50, 'ScanRate':0.1}}),
                                                        plot="tCV",
                                                        onoffafter="off",
                                        ...
                                        meta=dict(substrate=11, ma=str(round(dx* 100)*10) + '-' + str(round(dy * 100)*10)))    
        ...
        run_sequence= dict(soe=['motor/moveWaste_0', 'minipumping/formulation_0', 'motor/RemoveDroplet_0','motor/moveSample_0', 
                            ...
                            params= dict(moveWaste_0= dict(x=0, y=0, z=0),  
                                            ...
                                            moveSample_0= dict(x=0, y=0, z=0), 
                                            moveAbs_1 = dict(dx=dx, dy=dy, dz=dz),
                                            moveDown_0 = dict(dz=0.170, steps=80, maxForce=0.44, threshold= 0.175),
                                            setcurrentrange_0= dict(crange='100uA'),
                                            measure_0= dict(procedure="cp", setpointjson= json.dumps({'applycurrent': {'Setpoint value': 7*(10**-8)}, 
        ...
        run_sequence= dict(soe=['motor/moveWaste_0', 'minipumping/formulation_0', 'motor/RemoveDroplet_0','motor/moveSample_0', 
                            ...
                            params= dict(moveWaste_0= dict(x=0, y=0, z=0),  
                                            ...
                                            moveDown_0 = dict(dz=0.170, steps=80, maxForce=0.44, threshold= 0.175),
                                            setcurrentrange_0= dict(crange='100uA'),
                                            measure_0= dict(procedure="ca", setpointjson= json.dumps({'applypotential': {'Setpoint value': 0.735}, 
