...
test_fnc(dict(soe=['orchestrator/start', f'dobot/moveHome_{0}', f'force/read_{0}', f'palmsens/measure_{0}', 
                    f'dobot/moveHome_{1}'], 
            params={'start': {'collectionkey' : f'substrate_{substrate}'},
                    f'moveHome_{0}':{},
                    f'read_{0}': {},
...
test_fnc(dict(soe=['orchestrator/start', f'dobot/moveHome_{0}', f'dobot/moveWaste_{0}', f'psd/pumpSimple_{0}', f'force/read_{0}', f'dobot/moveHome_{1}', f'palmsens/measure_{0}'], 
            params={'start': {'collectionkey' : f'substrate_-999'},
                    f'moveHome_{0}':{},
                    f'moveWaste_{0}':{'x': 0, 'y':0, 'z': 0, 'r': 0},
                    f'pumpSimple_{0}': {'volume': 200, 'valve': 2, 'speed': 10, 'times': 2},
                    f'read_{0}': {},
...
test_fnc(dict(soe=['orchestrator/start', f'dobot/moveHome_{0}', f'palmsens/measure_{0}', f'force/read_{0}',
                    f'palmsens/measure_{1}', f'palmsens/measure_{2}', f'dobot/moveHome_{1}'], 
            params={'start': {'collectionkey' : f'substrate_{substrate}'},
                    f'moveHome_{0}':{},
                    f'measure_{0}':{'method': 'open_circuit_potentiometry',
                   ...
                   f'measure_{2}': {'method': 'cyclic_voltammetry',
                                'parameters': json.dumps({
                                        ...
                                        "scan_rate": 0.1,        
                                        "n_scans": 2}),
                                    'filename': 'substrate_{}_dummy_cv_{}_{}'.format(substrate, id0, 0)},          
                    f'moveHome_{1}':{}
                    },
            meta=dict()))
