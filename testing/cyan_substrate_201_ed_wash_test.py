...
I = 0.01*1e-3*math.pi*0.045*0.045
...
test_fnc(dict(soe=['orchestrator/start', f'dobot/moveHome_{0}', f'dobot/moveWaste_{0}', f'psd/pumpSimple_{0}', f'psd/pumpMix_{0}', 
                f'force/read_{0}', f'dobot/removeDrop_{0}', f'dobot/removeDrop_{1}', f'dobot/removeDrop_{2}',  f'psd/pumpSimple_{1}',
                    ...
                    f'palmsens/measure_{1}', f'palmsens/measure_{2}', f'palmsens/measure_{3}', f'psd/pumpSimple_{7}', f'dobot/moveJointRelative_{0}',
                    f'psd/pumpSimple_{8}', f'psd/pumpSimple_{9}', f'dobot/moveJointRelative_{1}', f'dobot/moveWaste_{1}', f'psd/pumpMix_{1}',
                    f'dobot/removeDrop_{3}', f'dobot/moveHome_{1}'], 
            params={'start': {'collectionkey' : f'substrate_{substrate}'},
                    f'moveHome_{0}':{},
                    f'moveWaste_{0}':{'x': 0, 'y': 0, 'z': 0, 'r': 0},
                    f'pumpSimple_{0}': {'volume': 250, 'valve': 1, 'speed': 25, 'times': 2},
                    f'pumpMix_{0}': {'V1': 0, 'V2': 150, 'V3': 0, 'V4': 150, 'V5': 0, 'V6': 0, 'mix_speed': 30, 'mix': 5, 'vial_speed': 15, 'times': 1, 'cell': True},
                    f'read_{0}': {},
                    ...
                    f'pumpSimple_{2}': {'volume': 35, 'valve': 8, 'speed': 25, 'times': 1},
                    f'pumpSimple_{3}': {'volume': -30, 'valve': 7, 'speed': 25, 'times': 1},
                    f'pumpSimple_{4}': {'volume': 35, 'valve': 8, 'speed': 25, 'times': 1},
                    f'pumpSimple_{5}': {'volume': -30, 'valve': 7, 'speed': 25, 'times': 1},
                    f'pumpSimple_{6}': {'volume': 40, 'valve': 8, 'speed': 25, 'times': 1},
                    f'read_{1}': {},
                    ...
                    f'measure_{3}':{'method': 'cyclic_voltammetry',
                                    'parameters': json.dumps({"equilibration_time": 10,  # Equilibration time in seconds
                                                            ...
                                                            "e_vtx1": 0.4,           # Vertex 1 potential in volts
                                    ...
                                    'filename': 'substrate_{}_cv_{}_{}'.format(substrate, i, 0),
                                    'substrate': substrate,
                                    'id': i,
                                    'experiment': 0},
                    f'pumpSimple_{7}': {'volume': -150, 'valve': 7, 'speed': 20, 'times': 1},
                    f'moveJointRelative_{0}':{'x': 0, 'y':0, 'z': 0.4, 'r': 0},
                    f'pumpSimple_{8}': {'volume': -150, 'valve': 7, 'speed': 30, 'times': 1},
                    f'pumpSimple_{9}': {'volume': -150, 'valve': 7, 'speed': 20, 'times': 1},
                    f'moveJointRelative_{1}':{'x': 0, 'y':0, 'z': 2, 'r': 0},
                    f'moveWaste_{1}':{'x': 0, 'y': 0, 'z': 0, 'r': 0},
                    f'pumpMix_{1}': {'V1': 0, 'V2': 0, 'V3': 200, 'V4': 0, 'V5': 0, 'V6': 0, 'mix_speed': 20, 'mix': 3, 'vial_speed': 12, 'times': 2, 'cell': True},
...
test_fnc(dict(soe=[f'dobot/moveHome_{0}', f'dobot/moveWaste_{0}', f'psd/pumpSimple_{0}', f'psd/pumpMix_{0}', 
                f'force/read_{0}', f'dobot/removeDrop_{0}', f'dobot/removeDrop_{1}', f'dobot/removeDrop_{2}',  f'psd/pumpSimple_{1}',
                    f'dobot/moveSample_{0}', f'dobot/moveSample_{1}', f'dobot/moveDown_{0}', f'psd/pumpSimple_{2}', f'psd/pumpSimple_{3}',
                    f'psd/pumpSimple_{4}', f'psd/pumpSimple_{5}', f'psd/pumpSimple_{6}', f'force/read_{1}', f'palmsens/measure_{0}',
                    f'psd/pumpSimple_{7}', f'dobot/moveJointRelative_{0}',
                    f'psd/pumpSimple_{8}', f'psd/pumpSimple_{9}', f'dobot/moveJointRelative_{1}', f'dobot/moveWaste_{1}', f'psd/pumpMix_{1}',
                    f'dobot/removeDrop_{3}', f'dobot/moveHome_{1}'], 
            params={f'moveHome_{0}':{},
                    f'moveWaste_{0}':{'x': 0, 'y': 0, 'z': 0, 'r': 0},
                    f'pumpSimple_{0}': {'volume': 250, 'valve': 4, 'speed': 25, 'times': 2},
                    f'pumpMix_{0}': {'V1': 0, 'V2': 0, 'V3': 250, 'V4': 0, 'V5': 0, 'V6': 0, 'mix_speed': 30, 'mix': 0, 'vial_speed': 15, 'times': 1, 'cell': True},
                    f'read_{0}': {},
                    f'removeDrop_{0}': {'x': 1, 'y': 0.5, 'z': 0, 'r': 0},
                    f'removeDrop_{1}': {'x': -1, 'y': 0.5, 'z': 0, 'r': 0},
                    f'removeDrop_{2}': {'x': 0, 'y': 0.5, 'z': 0, 'r': 0},
                    ...
                    f'moveSample_{1}': {'x': x, 'y': y, 'z': -13.6, 'r': 0},
                    f'moveDown_{0}': {'dz': 0.05, 'steps': 50, 'maxForce': 200, 'threshold': 0.1},
                    f'pumpSimple_{2}': {'volume': 35, 'valve': 3, 'speed': 25, 'times': 1},
                    f'pumpSimple_{3}': {'volume': -30, 'valve': 7, 'speed': 25, 'times': 1},
                    f'pumpSimple_{4}': {'volume': 35, 'valve': 3, 'speed': 25, 'times': 1},
                    f'pumpSimple_{5}': {'volume': -30, 'valve': 7, 'speed': 25, 'times': 1},
                    f'pumpSimple_{6}': {'volume': 40, 'valve': 3, 'speed': 25, 'times': 1},
                    f'read_{1}': {},
                    f'measure_{0}':{'method': 'open_circuit_potentiometry',
                                    'parameters': json.dumps({'t_run': 360.0, 't_interval': 5}),
...
test_fnc(dict(soe=[f'orchestrator/wait_{0}']+[f'dobot/moveJointRelative_{i}' for i in range(50)], 
                params={f'wait_{0}': {'addresses':f'experiment_{1}:0/pumpSimple_{8}'},
                        **{f'moveJointRelative_{i}': {'x': 0, 'y': 0, 'z': 0.02, 'r': 0} for i in range(50)}
                        },
                meta=dict()),1)
...
test_fnc(dict(soe=[f'dobot/moveHome_{0}', f'dobot/moveWaste_{0}', f'psd/pumpSimple_{0}', f'psd/pumpMix_{0}', 
            ...
            params={f'moveHome_{0}':{},
                    ...
                    f'moveJointRelative_{1}':{'x': 0, 'y':0, 'z': 2, 'r': 0},
                    f'moveWaste_{1}':{'x': 0, 'y': 0, 'z': 0, 'r': 0},
                    f'pumpMix_{1}': {'V1': 0, 'V2': 0, 'V3': 0, 'V4': 0, 'V5': 100, 'V6': 0, 'mix_speed': 20, 'mix': 3, 'vial_speed': 12, 'times': 2, 'cell': True},
                    f'removeDrop_{3}': {'x': 0, 'y': 0, 'z': 0, 'r': 0},                                    
                    f'moveHome_{1}':{}
                    },
            meta=dict()))
...
test_fnc(dict(soe=[f'dobot/moveHome_{0}', f'dobot/moveWaste_{0}', f'psd/pumpSimple_{0}', f'psd/pumpMix_{0}', 
                f'force/read_{0}', f'dobot/removeDrop_{0}', f'dobot/removeDrop_{1}', f'dobot/removeDrop_{2}',  f'psd/pumpSimple_{1}',
                    ...
                    f'palmsens/measure_{9}', f'palmsens/measure_{10}', f'palmsens/measure_{11}',
            ...
            params={f'moveHome_{0}':{},
                    f'moveWaste_{0}':{'x': 0, 'y': 0, 'z': 0, 'r': 0},
                    f'pumpSimple_{0}': {'volume': 100, 'valve': 6, 'speed': 30, 'times': 2},
                    ...
                    f'measure_{1}':{'method': 'potentiostatic_impedance_spectroscopy',
                                        'parameters': json.dumps({
                                            "e_dc": "None",                 # DC potential
                                            "e_ac": 0.01,                # AC potential (10 mV/s)
                                            "n_frequencies": int(10*4+1),         # Number of frequencies
                                            "max_frequency": 1e5,        # Maximum frequency
                    ...
                    f'measure_{2}':{'method': 'cyclic_voltammetry',
                                    'parameters': json.dumps({"equilibration_time": 10,  # Equilibration time in seconds
                                                            ...
                                                            "e_vtx1": 0.6,           # Vertex 1 potential in volts
                                                            "e_vtx2": -0.25,            # Vertex 2 potential in volts
                                                            "e_step": 0.005,           # Step potential in volts
                                                            "scan_rate": 0.05,         # Scan rate in V/s
                                    ...
                                    'id': i,
                                    'experiment': 1},
                    f'measure_{3}':{'method': 'open_circuit_potentiometry',
                                    'parameters': json.dumps({'t_run': 60.0, 't_interval': 0.5}),
                                    'filename': 'substrate_{}_ocp_{}_{}'.format(substrate, i, 2),
                                    'substrate': substrate,
                                    'id': i,
                                    'experiment': 2},
                    f'measure_{4}':{'method': 'potentiostatic_impedance_spectroscopy',
                                        'parameters': json.dumps({
                                            "e_dc": "None",                 # DC potential
                                            "e_ac": 0.01,                # AC potential (10 mV/s)
                                            "n_frequencies": int(10*4+1),         # Number of frequencies
                                        ...
                                        'id': i,
                                        'experiment': 2},
                    f'measure_{5}':{'method': 'cyclic_voltammetry',
                                    'parameters': json.dumps({"equilibration_time": 10,  # Equilibration time in seconds
                                                            "e_begin": 0.6,          # Begin potential in volts
                                    ...
                                    'filename': 'substrate_{}_cv_{}_{}'.format(substrate, i, 2),
                                    'substrate': substrate,
                                    'id': i,
                                    'experiment': 2},
                    ...
                    f'moveJointRelative_{1}':{'x': 0, 'y':0, 'z': 2, 'r': 0},
                    f'moveWaste_{1}':{'x': 0, 'y': 0, 'z': 0, 'r': 0},
                    f'pumpMix_{1}': {'V1': 0, 'V2': 0, 'V3': 0, 'V4': 0, 'V5': 200, 'V6': 0, 'mix_speed': 20, 'mix': 0, 'vial_speed': 12, 'times': 2, 'cell': True},
                    f'removeDrop_{3}': {'x': 0, 'y': 0, 'z': 0, 'r': 0},                                    
                    f'moveHome_{1}':{}
                    },
            meta=dict()))
...
test_fnc(dict(soe=[f'orchestrator/wait_{0}']+[f'dobot/moveJointRelative_{i}' for i in range(50)], 
                params={f'wait_{0}': {'addresses':f'experiment_{3}:0/pumpSimple_{8}'},
                        **{f'moveJointRelative_{i}': {'x': 0, 'y': 0, 'z': 0.02, 'r': 0} for i in range(50)}
                        },
                meta=dict()),1)
...
test_fnc(dict(soe=['orchestrator/start', f'dobot/moveHome_{0}', f'dobot/moveWaste_{0}', f'psd/pumpSimple_{0}', f'psd/pumpMix_{0}', 
                f'force/read_{0}', f'dobot/removeDrop_{0}', f'dobot/removeDrop_{1}', f'dobot/removeDrop_{2}',  f'psd/pumpSimple_{1}',
                    ...
                    f'psd/pumpSimple_{4}', f'psd/pumpSimple_{5}', f'psd/pumpSimple_{6}', f'force/read_{1}', f'palmsens/measure_{0}',
                    f'palmsens/measure_{1}', f'palmsens/measure_{2}', f'palmsens/measure_{3}', f'palmsens/measure_{4}',
                    f'palmsens/measure_{5}', f'palmsens/measure_{6}', f'psd/pumpSimple_{7}', f'dobot/moveJointRelative_{0}',
                    f'psd/pumpSimple_{8}', f'psd/pumpSimple_{9}', f'dobot/moveJointRelative_{1}', f'dobot/moveWaste_{1}', f'psd/pumpMix_{1}',
                    f'dobot/removeDrop_{3}', f'dobot/moveHome_{1}'], 
            params={'start': {'collectionkey' : f'substrate_{substrate}'},
                    f'moveHome_{0}':{},
                    f'moveWaste_{0}':{'x': 0, 'y': 0, 'z': 0, 'r': 0},
                    f'pumpSimple_{0}': {'volume': 250, 'valve': 6, 'speed': 25, 'times': 2},
                    f'pumpMix_{0}': {'V1': 0, 'V2': 0, 'V3': 0, 'V4': 0, 'V5': 250, 'V6': 0, 'mix_speed': 30, 'mix': 0, 'vial_speed': 15, 'times': 1, 'cell': True},
                    f'read_{0}': {},
                    f'removeDrop_{0}': {'x': 1, 'y': 0.5, 'z': 0, 'r': 0},
                    f'removeDrop_{1}': {'x': -1, 'y': 0.5, 'z': 0, 'r': 0},
                    f'removeDrop_{2}': {'x': 0, 'y': 0.5, 'z': 0, 'r': 0},
                    f'pumpSimple_{1}': {'volume': -15, 'valve': 7, 'speed': 25, 'times': 1},
                    f'moveSample_{0}': {'x': x, 'y': y, 'z': 0, 'r': 0},
                    f'moveSample_{1}': {'x': x, 'y': y, 'z': -13.6, 'r': 0},
                    f'moveDown_{0}': {'dz': 0.05, 'steps': 50, 'maxForce': 200, 'threshold': 0.1},
                    f'pumpSimple_{2}': {'volume': 35, 'valve': 6, 'speed': 20, 'times': 1},
                    ...
                    f'read_{1}': {},
                    f'measure_{0}':{'method': 'open_circuit_potentiometry',
                                    'parameters': json.dumps({'t_run': 60.0, 't_interval': 0.2}),
                                    'filename': 'substrate_{}_ocp_{}_{}'.format(substrate, i, 0),
                                    'substrate': substrate,
                                    'id': i,
                                    'experiment': 0},
                    f'measure_{1}':{'method': 'potentiostatic_impedance_spectroscopy',
                                        ...
                                        'id': i,
                                        'experiment': 0},
                    f'measure_{2}':{'method': 'open_circuit_potentiometry',
                                    'parameters': json.dumps({'t_run': 30.0, 't_interval': 0.2}),
                                    'filename': 'substrate_{}_ocp_{}_{}'.format(substrate, i, 1),
                                    'substrate': substrate,
                                    'id': i,
                                    'experiment': 1},
                    f'measure_{3}':{'method': 'cyclic_voltammetry',
                                    'parameters': json.dumps({"equilibration_time": 10,  # Equilibration time in seconds
                                                            ...
                                                            "e_vtx1": -0.4,           # Vertex 1 potential in volts
                                                            "e_vtx2": 1.2,            # Vertex 2 potential in volts
                                                            "e_step": 0.005,           # Step potential in volts
                                                            "scan_rate": 0.05,         # Scan rate in V/s
                    ...
                    f'measure_{5}':{'method': 'potentiostatic_impedance_spectroscopy',
                                        ...
                                        'id': i,
                                        'experiment': 2},
                    f'measure_{6}':{'method': 'open_circuit_potentiometry',
                                    'parameters': json.dumps({'t_run': 30.0, 't_interval': 0.2}),
                    ...
                    f'moveJointRelative_{1}':{'x': 0, 'y':0, 'z': 2, 'r': 0},
                    f'moveWaste_{1}':{'x': 0, 'y': 0, 'z': 0, 'r': 0},
                    f'pumpMix_{1}': {'V1': 0, 'V2': 0, 'V3': 0, 'V4': 0, 'V5': 200, 'V6': 0, 'mix_speed': 20, 'mix': 0, 'vial_speed': 12, 'times': 1, 'cell': True},
                    f'removeDrop_{3}': {'x': 0, 'y': 0, 'z': 0, 'r': 0},                                    
                    f'moveHome_{1}':{}
                    },
            meta=dict({'description': 'old 4M NaClO4 on FTO test'})))
...
test_fnc(dict(soe=[f'psd/pumpSimple_{7}', f'dobot/moveJointRelative_{0}', f'psd/pumpSimple_{8}', f'psd/pumpSimple_{9}', 
                   f'dobot/moveJointRelative_{1}', f'dobot/moveWaste_{1}', f'psd/pumpMix_{1}', f'dobot/removeDrop_{3}', f'dobot/moveHome_{1}'],
            params={f'pumpSimple_{7}': {'volume': -150, 'valve': 7, 'speed': 20, 'times': 1},
                    f'moveJointRelative_{0}':{'x': 0, 'y':0, 'z': 0.4, 'r': 0},
                    f'pumpSimple_{8}': {'volume': -150, 'valve': 7, 'speed': 30, 'times': 1},
                    f'pumpSimple_{9}': {'volume': -150, 'valve': 7, 'speed': 20, 'times': 1},
                    f'moveJointRelative_{1}':{'x': 0, 'y':0, 'z': 2, 'r': 0},
