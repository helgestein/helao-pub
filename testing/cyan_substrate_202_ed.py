...
for i in range(3,6):
        ...
        test_fnc(dict(soe=[f'dobot/moveHome_{0}', f'dobot/moveWaste_{0}', f'psd/pumpSimple_{0}', f'psd/pumpMix_{0}', 
                        f'force/read_{0}', f'dobot/removeDrop_{0}', f'dobot/removeDrop_{1}', f'dobot/removeDrop_{2}',  f'psd/pumpSimple_{1}',
                                ...
                                f'palmsens/measure_{1}', f'palmsens/measure_{2}', f'palmsens/measure_{3}', f'psd/pumpSimple_{7}',
                                f'dobot/moveJointRelative_{0}', f'psd/pumpSimple_{8}', f'psd/pumpSimple_{9}', f'dobot/moveJointRelative_{1}',
                                f'dobot/moveWaste_{1}', f'psd/pumpMix_{1}', f'psd/pumpSimple_{10}', f'dobot/removeDrop_{3}', f'dobot/moveHome_{1}'], 
                        params={f'moveHome_{0}':{},
                                f'moveWaste_{0}':{'x': 0, 'y': 0, 'z': 0, 'r': 0},
                                f'pumpSimple_{0}': {'volume': 125, 'valve': 2, 'speed': 25, 'times': 1},
                                f'pumpMix_{0}': {'V1': 0, 'V2': 25, 'V3': 200, 'V4': 25, 'V5': 0, 'V6': 0, 'mix_speed': 30, 'mix': 5, 'vial_speed': 15, 'times': 1, 'cell': True},
                                f'read_{0}': {},
                                ...
                                f'moveDown_{0}': {'dz': 0.05, 'steps': 50, 'maxForce': 175, 'threshold': 0.1},
                                ...
                                f'pumpMix_{1}': {'V1': 0, 'V2': 0, 'V3': 100, 'V4': 0, 'V5': 0, 'V6': 0, 'mix_speed': 20, 'mix': 3, 'vial_speed': 12, 'times': 3, 'cell': True},
                                f'pumpSimple_{10}': {'volume': 50, 'valve': 8, 'speed': 25, 'times': 1},
...
### prussian blue electrodeposition test (wide range)
i=135
x=grid[i][0]
y=grid[i][1]
print(x,y)
...
test_fnc(dict(soe=['orchestrator/start', f'dobot/moveHome_{0}', f'dobot/moveWaste_{0}', f'psd/pumpSimple_{0}', f'psd/pumpMix_{0}', 
                f'force/read_{0}', f'dobot/removeDrop_{0}', f'dobot/removeDrop_{1}', f'dobot/removeDrop_{2}',  f'psd/pumpSimple_{1}',
                        f'dobot/moveSample_{0}', f'dobot/moveSample_{1}', f'dobot/moveDown_{0}', f'psd/pumpSimple_{2}', f'psd/pumpSimple_{3}',
                        f'psd/pumpSimple_{4}', f'psd/pumpSimple_{5}', f'psd/pumpSimple_{6}', f'force/read_{1}', f'palmsens/measure_{0}',
                        f'palmsens/measure_{1}', f'palmsens/measure_{2}', f'palmsens/measure_{3}',
                ...
                params={'start': {'collectionkey' : f'substrate_{substrate}'},
                        ...
                        f'pumpMix_{0}': {'V1': 0, 'V2': 250, 'V3': 0, 'V4': 0, 'V5': 0, 'V6': 0, 'mix_speed': 30, 'mix': 5, 'vial_speed': 15, 'times': 1, 'cell': True},
                        f'read_{0}': {},
                        f'removeDrop_{0}': {'x': 1, 'y': 0.5, 'z': 0, 'r': 0},
                        f'removeDrop_{1}': {'x': -1, 'y': 0.5, 'z': 0, 'r': 0},
                        f'removeDrop_{2}': {'x': 0, 'y': 0.5, 'z': 0, 'r': 0},
                        ...
                        f'measure_{3}':{'method': 'cyclic_voltammetry',
                                        'parameters': json.dumps({"equilibration_time": 10,  # Equilibration time in seconds
                                                                "e_begin": 1.4,          # Begin potential in volts
                                                                "e_vtx1": -0.4,           # Vertex 1 potential in volts
                                                                "e_vtx2": 1.4,            # Vertex 2 potential in volts
                                                                "e_step": 0.005,           # Step potential in volts
                                                                "scan_rate": 0.05,         # Scan rate in V/s
                        ...
                        f'moveJointRelative_{1}':{'x': 0, 'y':0, 'z': 2, 'r': 0},
                        f'moveWaste_{1}':{'x': 0, 'y': 0, 'z': 0, 'r': 0},
                        f'pumpMix_{1}': {'V1': 0, 'V2': 0, 'V3': 75, 'V4': 0, 'V5': 0, 'V6': 0, 'mix_speed': 20, 'mix': 3, 'vial_speed': 12, 'times': 3, 'cell': True},
                        f'removeDrop_{3}': {'x': 0, 'y': 0, 'z': 0, 'r': 0},                                    
                        f'moveHome_{1}':{}
                        },
                meta=dict()))
