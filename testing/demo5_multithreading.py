...
for i in range(n):
    test_fnc(dict(soe=[f'orchestrator/wait_{i}',f'orchestrator/modify_{i}',f'measure:1/schwefelFunction_{i+1}',f'analysis/dummy_{i+1}'], 
...
test_fnc(dict(soe=['orchestrator/wait_0','orchestrator/modify_0','measure:2/schwefelFunction_0','analysis/dummy_0'], params={'wait_0':{'addresses':'experiment_0:2/activeLearning_0'},
...
for i in range(n):
    test_fnc(dict(soe=[f'orchestrator/wait_{i+1}',f'orchestrator/modify_{i+1}',f'measure:2/schwefelFunction_{i+1}',f'analysis/dummy_{i+1}'], 
