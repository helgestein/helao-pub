...
echem_test('measure', params=dict(procedure="ca", setpointjson="{'applypotential': {'Setpoint value': 0.01}, 'recordsignal': {'Duration': 20}}", plot="tCV", onoffafter="off", safepath="C:/Users/LaborRatte23-3/Documents/helao-dev/temp", filename="ca.nox", parseinstructions="recordsignal"))
...
echem_test('measure', params=dict(procedure="cv", setpointjson= json.dumps({'FHSetSetpointPotential': {'Setpoint value': -1}, 'FHWait': {'Time': 10}, 
                                        ...
                                        plot="tCV",
                                        onoffafter="off",
                                        safepath="C:\Users\LaborRatte23-3\Documents\helao-dev\temp", #C:\Users\LaborRatte23-3\Documents\helao-dev\temp
                                        filename="cv.nox",
                                        parseinstructions='CVLinearScanAdc164'))



echem_test('measure', params=dict(procedure="ca", setpointjson= json.dumps({'applypotential': {'Setpoint value': -1}, 'recordsignal': {'Duration': 20}}),
                                plot="tCV",
                                onoffafter="off",
                                safepath="C:\Users\LaborRatte23-3\Documents\helao-dev\temp",
                                filename="ca.nox",
